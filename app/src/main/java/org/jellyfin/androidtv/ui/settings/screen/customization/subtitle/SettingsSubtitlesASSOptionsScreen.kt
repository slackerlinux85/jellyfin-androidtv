	...
	SettingsColumn {
		...
		item {
			...
			ListButton(
				...
				trailingContent = { Text(stringResource(assRendererType.nameRes)) },
				captionContent = { Text(stringResource(R.string.preference_ass_renderer_description)) },
		...
		item {
			...
			ListButton(
				...
				trailingContent = {
					Box(modifier = Modifier.sizeIn(minWidth = 32.dp),contentAlignment = Alignment.CenterEnd)
					{
						Text(stringResource(assMaxRenderPixels.nameRes))
					}},
				captionContent = { Text(stringResource(R.string.preference_ass_maxrenderpixels_description)) },
